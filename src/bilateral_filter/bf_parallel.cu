 ...
 * @brief CUDA-based sequential implementation of Bilateral Filter
 * @date June 2021
 * 
    ...
    const int diameter, const double sigma_i, const double sigma_s)
{
    ...
    // Filtering process
    bf_parallel_k << < gridSize_2D, blockSize_2D >> > (temp_d, dst_d, radius, gi_d, gs_d,
